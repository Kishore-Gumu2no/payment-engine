...
// CORS configuration - supports both production Vercel and local development
const allowedOrigins = [
  'https://payment-engine-37fd.vercel.app',  // Production frontend
  'http://localhost:5173',                    // Local Vite dev server (if needed)
